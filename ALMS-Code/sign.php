...
<body>
        ...
        <nav>
            ...
            <div class="nav-links">
                <ul>
                    ...
                    <li><a href="login.php" class="he-btn">BACK</a></li>
                </ul>
            </div>
        </nav>
    </section>
    <div class="loginbox">
        ...
        <form name="f1" action="signup.php" method="POST">
            <p>name</p>
            <input type="text" name="uname" placeholder="Ex-abc">
            <p>Email</p>
            <input type="text" name="ename" placeholder="enter your email">
            <p> Password</p>
            <input type="password" name="password" placeholder="password">
            <p> comfirm Password</p>
            <input type="password" name="repeatpassword" placeholder="password"><br>
            <br>
            <br>
            <br>
            <p> <input type="submit" id="btn" name="Signup"></p>
        </form>
    </div>
